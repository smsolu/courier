 ...
 * EntidadEmpresa
 *
 * @ORM\Table(name="tipo_proceso", indexes={@ORM\Index(name="tipo_proceso_codigo", columns={"codigo"}), @ORM\Index(name="fk_tipoproceso_estudio", columns={"id_estudio"})})
 * @ORM\Entity
 */
class TipoProceso extends LP_Entity
{
