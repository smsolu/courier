 ...
 *
 * @ORM\Table(name="caracter_interviniente", indexes={@ORM\Index(name="caracter_interviniente_codigo", columns={"codigo"}), @ORM\Index(name="fk_caracter_estudio", columns={"id_estudio"})})
 * @ORM\Entity
 */
class CaracterInterviniente extends LP_Entity
{
    /**
     * @var integer
     *
