 ...
 */
class ExpedienteCamara extends \AppBundle\Entity\ExpedienteCamara implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ExpedienteCamara' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\ExpedienteCamara' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\ExpedienteCamara' . "\0" . 'codigo', '' . "\0" . 'AppBundle\\Entity\\ExpedienteCamara' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\ExpedienteCamara' . "\0" . 'abreviatura');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExpedienteCamara $proxy) {
    ...
    public function setAbreviatura($abreviatura)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAbreviatura', array($abreviatura));
    ...
    public function getAbreviatura()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAbreviatura', array());
